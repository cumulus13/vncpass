...
reg add "HKLM\SOFTWARE\TightVNC\Server" /v Password /t REG_BINARY /d d9923c562a209db7 /f
reg add "HKLM\SOFTWARE\TightVNC\Server" /v ControlPassword /t REG_BINARY /d d9923c562a209db7 /f
